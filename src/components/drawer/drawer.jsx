    ...
    <div className={styles.container}>
        ...
        <div className={styles.buttonsContainer}>
            <div className={styles.section}>
                {firstSection.map((item, index) => <button><img src={item.icon}/><span>{item.title}</span></button>)}
            </div>
            <div className={styles.section}>
                {secondSection.map((item, index) => <button><img src={item.icon}/><span>{item.title}</span></button>)}
            </div>
            <div className={styles.section}>
                {thirdSection.map((item, index) => <button onClick={item.onClick}><img src={item.icon}/><span>{item.title}</span></button>)}
            </div>
            <div className={styles.section}>
                {fourthSection.map((item, index) => <button><img src={item.icon}/><span>{item.title}</span></button>)}
            </div>
            <div className={styles.section}>
                {fifthSection.map((item, index) => <button><img src={item.icon}/><span>{item.title}</span></button>
                    )}
            </div>
        </div>
